...
/*
textarea data-type 따른 수정내용 setting
data-type이 '2'인 경우 : this.elContentsField.value
그 외 : this.elContentsField.innerHTML
*/
var a=(j$(this.elContentsField).attr('data-type') == '2')?this.elContentsField.value:this.elContentsField.innerHTML;
a=a.replace(/^\s+/,"");
//console.log("data-type:" + j$(this.elContentsField).attr('data-type'));
if(j$(this.elContentsField).attr('data-type') == '1'){
	a=a.replace(/\n|\r/g,"<br/>");
}
//console.log("a:" + a);
