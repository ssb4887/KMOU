...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	makePopupURL : function(){
		...
		var varThisHref = location.href;
		var varStrs = varThisHref.split('?');
		var varQueryStr = '';
		if(varStrs.length > 1)	varQueryStr = '?' + varStrs[1] + "&dl=1";
		else varQueryStr += "?dl=1";
		var sPopupUrl=gVarSPath + '/editor/photoUpload.do' + varQueryStr;
		//var sPopupUrl="./photo_uploader/popup/photo_uploader.jsp" + varQueryStr;
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '<img src="{=sOriginalImageURL}" alt="" title="{=sName}" >';
