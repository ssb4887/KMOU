...
<a href="<c:out value="${defaultListUrl}${firstPageNo}"/>" class="page-link" title="처음 페이지"><img src="<c:out value="${contextPath}${imgPath}/common/arr_2x_gray.png"/>" alt="처음 페이지" /></a>
</li>
<li class="page-item page-prev">
<a href="<c:out value="${defaultListUrl}${prevPageNo}"/>" class="page-link" title="이전 페이지"><img src="<c:out value="${contextPath}${imgPath}/common/arr_bottom_gray.png"/>" alt="이전 페이지" /></a>
</li>
</c:if>
<c:forEach var="pageNo" begin="${firstPageNoOnPageList}" end="${lastPageNoOnPageList}">
<c:choose>
<c:when test="${pageNo == currentPageNo}"><li class="page-item active"><strong><a class="page-link" href="#">${pageNo}</a></strong></li></c:when>
...
<a href="<c:out value="${defaultListUrl}${nextPageNo}"/>" class="page-link" title="다음 페이지"><img src="<c:out value="${contextPath}${imgPath}/common/arr_bottom_gray.png"/>" alt="다음 페이지" /></a>
</li>
<li class="page-item page-last">
<a href="<c:out value="${defaultListUrl}${lastPageNo}"/>" class="page-link" title="끝 페이지"><img src="<c:out value="${contextPath}${imgPath}/common/arr_2x_gray.png"/>" alt="끝 페이지" /></a>
</li>
</c:if>
</c:if>