...
<c:if test="${totalPageCount > pageSize}">
	...
	<li class="page-item page-first">
		<a href="javascript:clickPage('${firstPageNo}')" class="page-link" title="처음 페이지">
	...
	<li class="page-item page-prev">
		<a href="javascript:clickPage('${prevPageNo}')" class="page-link" title="이전 페이지">
...
<!-- <span class="page-num"> -->
	<c:forEach var="pageNo" begin="${firstPageNoOnPageList}" end="${lastPageNoOnPageList}">
		<c:choose>
			...
			<c:otherwise>
				<li class="page-item">
					<a class="page-link" href="javascript:clickPage('${pageNo}')" title="${pageNo} 페이지">${pageNo}</a>
				</li>
			</c:otherwise>
		</c:choose>
	</c:forEach>
...
<li class="page-item page-next">
	<a href="javascript:clickPage('${nextPageNo}')" class="page-link" title="다음 페이지">
		<img src="<c:out value="${contextPath}/${crtSiteId}/assets/images/arr_bottom_gray.png"/>" alt="다음 페이지" />
	</a>
</li>
<li class="page-item page-last">
	<a href="javascript:clickPage('${lastPageNo}')" class="page-link" title="끝 페이지">
