...
<%-- 		<c:out value="${isAdm }"/><br> --%>
<%-- 		<c:out value="${mainLink }"/><br> --%>
<%-- 		<c:out value="${contRUriPath }"/> --%>
<!-- 
...
<mnui:contMenuLnbFADM level="${slevel}" menuList="${menuList[0]['menu-list']}" menus="${menus}" ulClass="${ulClass}"/>
