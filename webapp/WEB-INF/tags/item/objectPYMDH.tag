...
<c:if test="${!empty itemObj}">
	...
	<spring:message var="itemYMDName" code="item.ymd.name"/>
	<spring:message var="ymdOptTitle" code="item.itemId.select.name" arguments="${itemYMDName}"/>
	...
	<button type="button" id="${btnId}11" title="${btnText}" class="${btnClass}">${btnText}</button>
	...
	<button type="button" id="${btnId}21" title="${btnText}" class="${btnClass}">${btnText}</button>
