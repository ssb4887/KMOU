...
<td<c:if test="${colspan > 0}"> colspan="${colspan}"</c:if>>
	<itui:objectBUSINUMB itemId="${itemId}" itemInfo="${itemInfo}" objDt="${objDt}" objVal="${objVal}" objClass1="${objClass1}" objClass2="${objClass2}" objClass3="${objClass3}" objStyle1="${objStyle1}" objStyle2="${objStyle2}" objStyle3="${objStyle3}"/>
</td>
</c:if>