...
<c:if test="${!empty itemObj}">
	...
	<c:set var="objVal3" value="${objVals[2]}"/>
	</c:if>
	<c:if test="${empty objStyle1}"><c:set var="objStyle1" value="width:80px;"/></c:if>
	<c:if test="${empty objStyle2}"><c:set var="objStyle2" value="width:60px;"/></c:if>
	...
	<input type="text" id="${itemId}1" name="${itemId}1" title="${itemName}" class="${objClass1}" style="ime-mode:disabled;${objStyle1}" maxlength="3"<c:if test="${required == 1}"> required="required"</c:if> value="<c:out value="${objVal1}"/>"/>
	<span>-</span>
	<input type="text" id="${itemId}2" name="${itemId}2" title="${itemName}" class="${objClass2}" style="ime-mode:disabled;${objStyle2}" maxlength="2"<c:if test="${required == 1}"> required="required"</c:if> value="<c:out value="${objVal2}"/>"/>
	<span>-</span>
	<input type="text" id="${itemId}3" name="${itemId}3" title="${itemName}" class="${objClass3}" style="ime-mode:disabled;${objStyle3}" maxlength="5"<c:if test="${required == 1}"> required="required"</c:if> value="<c:out value="${objVal3}"/>"/>
</c:if>