...
<!-- 				<li> -->
				<c:choose>
					<c:when test="${!empty downloadUrl}"><a href="<c:out value="${downloadUrl}"/>&fidx=<c:out value="${optnDt.FLE_IDX}"/>&itId=<c:out value="${optnDt.ITEM_ID}"/>" class="txt file"><c:out value="${optnDt[originColumnId]}"/></a></c:when>
					<c:otherwise><a href="<c:out value="${URL_DOWNLOAD}"/>&${keyItemId}=<c:out value="${optnDt[keyColumnId]}"/>&fidx=<c:out value="${optnDt.FLE_IDX}"/>&itId=<c:out value="${optnDt.ITEM_ID}"/>" class="txt file"><c:out value="${optnDt[originColumnId]}"/></a></c:otherwise>
				</c:choose>
<!-- 				</li> -->
			</c:forEach>
<!-- 			</ul> -->
