			<div class="btnTopFull" style="margin-top:0px; margin-left:17px; margin-bottpm:10px;display:none;"> 
			<h4>메뉴</h4>
			<form id="fn_searchSVerForm" name="fn_searchSVerForm" method="get" action="<%=MenuUtil.getMenuUrl(10) %>">
				...
				<fieldset>
					...
					<button type="submit" class="btnSearch btnTFDL" id="fn_btn_search_sversion">선택</button>
				</fieldset>
			</form> 
			</div>
