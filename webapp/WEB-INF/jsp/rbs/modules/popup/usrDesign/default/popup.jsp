...
<jsp:include page="${jspRbsPath}/include/popup_top.jsp" flush="false">
	<jsp:param name="javascript_page" value="${moduleJspRPath}/popup.jsp"/>
</jsp:include>
...
<jsp:include page = "${jspRbsPath}/include/popup_bottom.jsp" flush = "false"/>