			...
			<div class="wrap">
				<div class="poll_ing">
					<dl class="p">
						...
						<dd class="num">
							<span class="tlt">참여인원 : </span><span style="margin-right:10px;"><c:out value="${dt.RESP_CNT}"/> 명</span>
							<a href="<c:out value="${URL_RESPLIST}"/>&pollIdx=<c:out value="${param.pollIdx}"/>" class="btnTypeM fn_btn_resplist_open" style="height:20px; line-height:20px;">참여목록</a>
						</dd>
