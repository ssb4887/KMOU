...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		<jsp:param name="javascript_page" value="${moduleJspRPath}/studMstBmk.jsp"/>
	</jsp:include>
</c:if>
<div class="">
	<ul class="tabTypeA tab li4" style="margin-bottom:40px;">
		<li class="fn_tab_view"><a id="tab1" href="${URL_STUDENT_BOOKMART}">학생설계전공 찜수</a></li>
		<li class="fn_tab_view on"><a id="tab2" href="${URL_STUDENT_MOST_BOOKMART}">학생설계전공 인기 찜</a></li>
	</ul>
</div>
...
<div id="cms_board_article" class="subConBox">
	...
	<div class="tbSearch tbShowDt">
		<form id="searchForm" action="<c:out value="${URL_STUDENT_MOST_BOOKMART_DATA}"/>" method="post" target="submit_target" style="width: 100%;">
