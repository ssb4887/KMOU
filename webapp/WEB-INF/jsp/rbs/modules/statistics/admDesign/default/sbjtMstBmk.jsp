...
<c:if test="${!empty TOP_PAGE}">
    <jsp:include page="${TOP_PAGE}" flush="false">
        <jsp:param name="javascript_page" value="${moduleJspRPath}/sbjtMstBmk.jsp"/>
    </jsp:include>
</c:if>

<div class="">
    <ul class="tabTypeA tab li4" style="margin-bottom:40px;">
        <li class="fn_tab_view"><a id="tab1" href="${URL_SBJT_BOOKMART}" >교과목 찜수</a></li>
        <li class="fn_tab_view on"><a id="tab2" href="${URL_SBJT_MOST_BOOKMART}">교과목 인기 찜</a></li>
    </ul>
</div>
