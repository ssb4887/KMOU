			...
			<a href="<c:out value="${URL_VIEW}"/>&${listIdxName}=${listKey}">
				<div class="top-cont">
					<div class="user-info-line">
						<span class="image">
							<c:if test="${!empty listDt.imgStr}">
								<img src="data:image/png;base64,${listDt.imgStr}" onError="${contextPath}/${crtSiteId}/assets/images/contents/human.png" alt="교수 사진">
							</c:if>
									
				
							<c:if test="${empty listDt.imgStr}">
								<img src="${contextPath}/${crtSiteId}/assets/images/contents/human.png" onError="${contextPath}/${crtSiteId}/assets/images/contents/human.png" alt="교수 사진">
							</c:if>
						</span>
						<div class="right">
