...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		<jsp:param name="javascript_page" value="${moduleJspRPath}/usrScript/profApproveChgModify.jsp"/>
	</jsp:include>
</c:if>
...
<!-- 										<th scope="col" class="border-end">전체</th> -->
	...
	<!-- 			승인 의견 -->
								...
								<tbody>
									<tr>
										...
										<td class="guid_opi text-start align-middle">
											<textarea class="form-control border-bottom" rows="4" placeholder="-" id="rjtResn">${INFO.RJT_RESN }</textarea>
			...
			<section class="plan_button_wrap d-flex flex-wrap justify-content-center gap-2 gap-md-3 mt-4">
					<button onclick="approve()" type="button" class="border-0 py-3" style="background-color: #003C92;">승인</button>
					<button onclick="reject()" type="button" class="border-0 py-3" style="background-color: #309CBE;">반려</button>
			</section>
		</section>
	</div>
</div>
