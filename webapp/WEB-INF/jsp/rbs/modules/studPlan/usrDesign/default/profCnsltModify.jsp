...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		<jsp:param name="javascript_page" value="${moduleJspRPath}/usrScript/profCnsltModify.jsp"/>
	</jsp:include>
</c:if>
...
<!-- 			컨설팅 결과 -->
							...
							<tbody>
                                   <tr>
                                       ...
                                       <td class="guid_opi text-start align-middle">
                                           <textarea class="form-control border-bottom" rows="4" placeholder="-" id="configCurric" >${CNSLT_INFO[0].SBJT_CNST_ADV_OPIN }</textarea>
                                   ...
                                   <tr>
                                       ...
                                       <td class="guid_opi text-start align-middle">
                                           <textarea class="form-control border-bottom" rows="4" placeholder="-" id="majorNName" >${CNSLT_INFO[0].MJ_NM_ADV_OPIN }</textarea>
                                   ...
                                   <tr>
                                       ...
                                       <td class="guid_opi text-start align-middle">
                                           <textarea class="form-control border-bottom" rows="4" placeholder="-" id="awwwardDegrre" >${CNSLT_INFO[0].AWD_DEGR_NM_ADV_OPIN }</textarea>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="guid_opi text-start align-middle">
                                        	<textarea class="form-control border-bottom" rows="2" placeholder="방문상담 신청시에만 입력해 주세요.(연락처, 연구실위치, 방문요청날짜 등)" id="reqMeetMsg">${CNSLT_INFO[0].MEET_CNSLT_ADV_OPIN}</textarea>
			...
			<section class="plan_button_wrap d-flex flex-wrap justify-content-center gap-2 gap-md-3 mt-4">
					<button onclick="cnsltTempSave()" type="button" class="border-0 py-3" style="background-color: #309CBE;">임시 저장</button>
					<button onclick="cnsltComplete()" type="button" class="border-0 py-3" style="background-color: #003C92;">상담 완료</button>
					<button onclick="cnsltRequestMeeting()" type="button" class="border-0 py-3" style="background-color: #4571E9;">방문상담 요청</button>
			</section>
		</section>
	</div>
</div>
