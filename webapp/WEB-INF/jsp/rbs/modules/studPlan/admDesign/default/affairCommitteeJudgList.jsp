...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		<jsp:param name="javascript_page" value="${moduleJspRPath}/admScript/affairCommitteeJudgList.jsp"/>
...
<div id="cms_board_article">
	...
	<div class="tbMSearch">
		...
		<p style="padding-bottom: 15px;">
			<button type="button" onclick="javascript:getAffairCommitteeList(1)" class="btnSearch">검색</button>
...
<%-- 		<form id="${listFormId}" name="${listFormId}" method="post" target="list_target"> --%>
	<table class="tbListA" summary="<c:out value="${settingInfo.list_title}"/> 목록을 볼 수 있고 수정 링크를 통해서 수정페이지로 이동합니다.">
		...
		<tr>
			...
			<th scope="col">신청자</th>
			<th scope="col">교무회 및 평의원회 승인일시</th>
			<th scope="col"></th>
		</tr>
		</thead>
