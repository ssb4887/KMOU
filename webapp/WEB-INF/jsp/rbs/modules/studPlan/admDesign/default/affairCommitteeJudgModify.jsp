...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		<jsp:param name="javascript_page" value="${moduleJspRPath}/admScript/affairCommitteeJudgModify.jsp"/>
	</jsp:include>
</c:if>
				...
				<div class="d-flex flex-wrap table_wrap">
						<table class="tbListB">
							...
							<tbody>
								...
								<tr>
									<th>개설사유</th>
									<td colspan="3"><c:out value="${INFO.APLY_RESN_KOR}"/></td>
								</tr>								
							</tbody>
						</table>
					</div>
						...
						<div class="d-flex flex-wrap table_wrap">
							...
							<table class="tbListB">
								...
								<tbody>
									<tr>
										<td colspan="2">
											<textarea class="" style="width:100%;" rows="5" placeholder="<c:if test="${INFO.STATUS eq '60' }">반려 시 필수입력입니다.(승인 시 선택입력)</c:if>" id="judgOpin" <c:if test="${INFO.STATUS gt '60' }">disabled</c:if>>${INFO.AFFAIR_COMMITTEE_JUDG_OPIN }</textarea>
