...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		<jsp:param name="javascript_page" value="${moduleJspRPath}/admScript/lastSupplementModify.jsp"/>
	</jsp:include>
</c:if>
							...
							<table class="tbListB">
								...
								<tbody>
									<tr>
										<th>전공 국문명</th>
										<td>
											<input type="text" name="SDM_KOR_NM" placeholder="국문명" value="${INFO.SDM_KOR_NM }" ${disabled}>
										</td>
										<th>전공 영문명</th>
										<td>
											<input type="text" name="SDM_ENG_NM" placeholder="영문명" value="${INFO.SDM_ENG_NM }" ${disabled}>
										</td>
									</tr>
									<tr>
										<th>운영 주관학과</th>
									...
									<tr>
										<th>수여학위 국문명</th>
										<td>
											<input type="text" name="AWD_DEGR_KOR_NM" placeholder="학사" value="${INFO.AWD_DEGR_KOR_NM }" ${disabled}>
										</td>
										<th>수여학위 영문명</th>
										<td>
											<input type="text" name="AWD_DEGR_ENG_NM" placeholder="학사(영문)" value="${INFO.AWD_DEGR_ENG_NM }" ${disabled}>
										</td>
									</tr>
									<tr>
										<th>관련 인재상</th>
										<td colspan="3">
											<textarea id="" name="IDEAL_STU_KOR" style="width:100%;" placeholder="-" ${disabled}>${INFO.IDEAL_STU_KOR }</textarea>
										</td>
									</tr>
									<tr>
										<th>관련 직업분야</th>								
										<td colspan="3">
										<textarea id="" name="CONC_JOB_KOR" style="width:100%;" placeholder="-" ${disabled}>${INFO.CONC_JOB_KOR }</textarea>
										</td>
									</tr>
									<tr>
										<th>관련 학문 분야</th>
										<td colspan="3">
										<textarea id="" name="CONC_STUD_FLD_KOR" style="width:100%;" placeholder="-" ${disabled}>${INFO.CONC_STUD_FLD_KOR }</textarea>
										</td>
									</tr>
									<tr>
										<th>요구되는 기초능력</th>
										<td colspan="3">
										<textarea id="" name="DMND_BASE_LRN_ABTY_KOR" style="width:100%;" placeholder="-" ${disabled}>${INFO.DMND_BASE_LRN_ABTY_KOR }</textarea>
										</td>
									</tr>
									<tr>
										<th>이수계획</th>
										<td colspan="3">
										<textarea id="" name="CPTN_PLAN_KOR" style="width:100%;" placeholder="-" ${disabled}>${INFO.CPTN_PLAN_KOR }</textarea>
										</td>
									</tr>
									<tr>
										<th>기타 사항</th>
										<td colspan="3">
										<textarea id="" name="ETC_CTNT" style="width:100%;" placeholder="-" ${disabled}>${INFO.ETC_CTNT }</textarea>
										</td>
									</tr>
									<tr>
										<th>개설사유</th>
										<td colspan="3">
										<textarea id="" name="APLY_RESN_KOR" style="width:100%;" placeholder="-" ${disabled}>${INFO.APLY_RESN_KOR }</textarea>
										</td>
									</tr>								
								</tbody>
							</table>
...
<!-- 					</div> -->
					...
					<section class="plan_dtl_section plan_dtl_basic" style="margin:40px 0;">
						<div class="d-flex flex-wrap table_wrap">
							<table class="tbListB">
								...
								<tbody>
									<tr>
										<c:if test="${!empty INFO.EDU_CENTER_JUDG_DT }">
										<th scope="col">창의융합교육센터 검토 의견</th>
										<td style="text-align:left;">
											${INFO.EDU_CENTER_JUDG_OPIN }
										</td>
										</c:if>
									</tr>
									<tr>
			...
			<c:if test="${INFO.STATUS eq '70' }">
			<div class="btnCenter">
				<a href="javascript:" onclick="save()" class="btnTypeA fn_btn_submit">저장</a>
				<a href="javascript:" onclick="complete()" class="btnTypeC">수정마감</a>
			</div>			
			</c:if>		
		</section>
	</div>
