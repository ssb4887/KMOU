...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		<jsp:param name="javascript_page" value="${moduleJspRPath}/admScript/departChgJudgModify.jsp"/>
	</jsp:include>
</c:if>
						...
						<div class="d-flex flex-wrap table_wrap">
							...
							<table class="tbListB">
								...
								<tbody>
									<tr>
										<td colspan="2">
											<textarea class="" style="width:100%;" rows="5" placeholder="<c:if test="${INFO.STATUS eq '50' }">반려 시 필수입력입니다.(승인 시 선택입력)</c:if>" id="judgOpin" <c:if test="${INFO.STATUS gt '50' }">disabled</c:if>>${INFO.DEPART_JUDG_OPIN }</textarea>
