...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		<jsp:param name="javascript_page" value="${moduleJspRPath}/admScript/eduCenterJudgList.jsp"/>
...
<div id="cms_board_article">
	...
	<div class="tbMSearch">
		...
		<p style="padding-bottom: 15px;">
			<button type="button" onclick="javascript:getEduCenterJudgList(1)" class="btnSearch">검색</button>
