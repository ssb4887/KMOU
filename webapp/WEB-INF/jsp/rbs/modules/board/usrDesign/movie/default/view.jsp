...
<c:if test="${!empty TOP_PAGE}">
	...
	<div id="cms_board_article">
		...
		<c:set var="exceptIds" value="${fn:split('name,notice,subject,file,contents,listImg,movieFile',',')}"/>
		...
		<table class="tbViewA" summary="${summary}">
			...
			<tbody>
				...
				<tr>
					<td class="cont fn_img" colspan="6"><itui:objectMovieView itemId="movieFile" itemInfo="${itemInfo}" objDt="${dt}"/></td>
				</tr>
				<tr>
