...
<div class="container_wrap">
	<div class="sub_wrap">
		<div class="sub_background commu_bg">
			<section class="inner">
				<h3 class="title fw-bolder text-center">오류신고</h3>
			</section>
		</div>
		<!--본문-->
...
<!-- 							<input type="text" id="input01-01" name="input01-01" class="form-control" placeholder="제목을 입력하세요">      -->
			...
			<div class="d-flex flex-row gap-3 justify-content-center mt-4">
				<button type="submit" class="qna_conf border-0 text-center text-white py-2">저장</button>
				<button type="button" class="qna_dele border-0 text-center text-white py-2">작성취소</button>
			</div>
			</form>
		</section>
	</div>
