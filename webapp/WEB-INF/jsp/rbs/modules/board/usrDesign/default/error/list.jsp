...
<!--content-->
	...
	<c:set var="dsetCateListId" value="${settingInfo.dset_cate_list_id}"/>
		...
		<div class="sub_background commu_bg">
			<section class="inner">
				<h3 class="title fw-bolder text-center text-white">오류신고</h3>
				<p class="sub_title_script">지능형 교과·비교과 사이트의 오류 및 개선사항에 관한 내용을 제보하는 공간입니다.</p>
			</section>
		</div>
		<!--본문-->
		<section class="inner mt-5">
			<section class="qna_desc d-flex flex-column flex-sm-row align-items-center gap-3 justify-content-center">
				<div class="img_box">
					<img src="${contextPath}/${crtSiteId}/images/write_wraning2.png" alt="글쓰기주의사항 이미지" />
				</div>
				<ul>
			...
			<div class="com_tab">
				<ul class="tab_menuA">
        		  ...
        		  <li class="on"><a href="<%=MenuUtil.getMenuUrl(67) %>">오류신고</a></li>
			...
			<div class="view_written d-flex justify-content-end my-3">
				<form name="srchForm" method="post" action="/web/board/list.do?mId=67">
			...
			<table class="table notice_table">
				<caption class="blind">오류제보 테이블</caption>
				<colgroup>
					<col width="8%" />
					<col width="auto" />
					<col width="12%" />
				...
				<tbody>
					...
					<tr>
						<td colspan="${colSpan}" class="bllist" style="text-align:center; width:100%;"><spring:message code="message.no.list"/></td>
					</tr>
					</c:if>
