	...
	<c:set var="dsetCateListId" value="${settingInfo.dset_cate_list_id}"/>
		...
		<section class="inner mt-5">
			<section class="qna_desc d-flex flex-column flex-sm-row align-items-center gap-3 justify-content-center">
				<div class="img_box">
					<img src="${contextPath}/${crtSiteId}/images/write_wraning.png" alt="글쓰기주의사항 이미지" />
				</div>
				<ul>
			...
			<div class="com_tab">
				<ul class="tab_menuA">
				  <li class="on"><a href="<%=MenuUtil.getMenuUrl(39) %>">공지사항</a></li>
			...
			<div class="view_written d-flex justify-content-end my-3">
				...
				<form name="srchForm" method="post" action="/web/board/list.do?mId=39">
			...
			<table class="table notice_table">
				<caption class="blind">공지사항 테이블</caption>
				<colgroup>
					<col width="8%" />
					<col width="auto" />
					<col width="12%" />
