...
<!-- 	<div id="cms_board_article"> -->
			...
			<section class="inner mt-4">
				<div class="inner ntc_view_title">
				<h2><c:out value="${dt.SUBJECT}"/></h2>
				</div>
					...
					<table class="table noti_view">
						...
						<tbody>
							<tr>
								...
								<th scope="row" class="align-middle">작성일</th>
					...
					<!--qna 컨텐츠 내용-->
					<div class="noti_view">
						<div class="qna_container noti_view c_bx">
							<div class="qna_qbx">
...
<!-- 				<button type="button" class="qna_dele border-0 text-center text-white py-2">삭제</button> -->
					<c:if test="${isReply eq 'false'}">
					 <a href="<c:out value="${URL_MODIFY}&brdIdx=${dt.BRD_IDX}"/>" title="수정" class="btn_st1">수정</a>
					</c:if>
