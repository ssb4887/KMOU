			...
			<form name="fn_passwordForm" id="fn_passwordForm" method="post" target="submit_target">
				...
				<fieldset>
					...
					<table class="tbWriteA" summary="글쓰기 서식" style="margin:20px auto;width:90%;">
						...
						<tbody>
							<tr>
								<th><label for="pwd" class="required"><spring:message code="item.board.password"/></label></th>
								<td><input type="password" id="pwd" name="pwd" class="inputTxt" maxlength="16" required="required" title="<spring:message code="item.board.password"/>"/></td>
