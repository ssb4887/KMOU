...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		<jsp:param name="page_tit" value="${settingInfo.list_title} (${queryString.tit})"/>
	...
	<div id="cms_board_article">
		...
		<c:if test="${mngAuth}">
		<!-- input -->
		<iframe id="fn_ifrm_input" name="fn_ifrm_input" src="<c:out value="${URL_INPUT}"/>" frameBorder="0px" scrolling="no" scrollbar="no" style="width:100%;height:250px;border;0px;"></iframe>
		<!-- // input -->
		</c:if>
		<!-- button -->
