...
<c:set var="itemObjs" value="${itemInfo.items}"/>
	<div id="cms_board_article">
		...
		<table id="tpSubContent" class="tbWriteA"
...
<!-- 					</td> -->
					...
					<td>
						<select name="is_sptPsnKor${i.index }" id="s_sptPsnKor${i.index }" class="select" style="width:60%;" title="인재상">														
						</select>
					</td>
...
<%-- 					<td><itui:objectView itemId="lastModiId" itemInfo="${itemInfo}" objDt="${listDt}"/></td> --%>
				...
				<input type="hidden" name="pnt${i.index }" id="pnt${i.index }" value="${pnt }"/>
				<input type="hidden" name="theoTmCnt${i.index }" id="theoTmCnt${i.index }" value="${theoTmCnt }"/>
				<input type="hidden" name="pracTmCnt${i.index }" id="pracTmCnt${i.index }" value="${pracTmCnt }"/>
				...
				<input type="hidden" name="sbjtNmEng${i.index }" id="sbjtNmEng${i.index }" value="${listDt.SBJT_NM_ENG }"/>
