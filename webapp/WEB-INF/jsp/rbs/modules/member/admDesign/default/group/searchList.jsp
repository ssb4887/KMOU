	...
	<div id="cms_board_article">
		...
		<table class="tbListA" summary="<c:out value="${settingInfo.list_title}"/> 검색 목록을 볼 수 있습니다.">
			...
			<tbody class="alignC">
				...
				<tr>
					<td><input type="checkbox" id="select" name="select" title="<spring:message code="item.select"/>" value="${listKey}" data-name="<c:out value="${listDt.GROUP_NAME}"/>"/></td>
					<td class="num">${listNo}</td>
					<td><c:out value="${listKey}"/></td>
					<td><c:out value="${listDt.GROUP_NAME}"/></td>
				</tr>
