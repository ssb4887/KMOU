...
<%
String paramR1 = request.getParameter("url");
String paramR2 = "nmA";
if(StringUtil.isEmpty(paramR1)) paramR1 = StringUtil.getString(request.getAttribute("indexUrl"));
if(!StringUtil.isEmpty(paramR1) && !paramR1.startsWith("http://") && !paramR1.startsWith("https://")) {
	paramR1 = request.getContextPath() + paramR1;
}
%>
			...
			<ul>
				...
				<li class="line">
					...
					<form name="form_chk" method="post">
						...
						<%-- <input type="hidden" name="param_r1" value="<c:out value="${url}"/>">
