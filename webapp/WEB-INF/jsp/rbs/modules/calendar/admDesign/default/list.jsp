...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
     ...
     <div id="calendar">
     <div class="date" >
					<a href="<c:out value="${URL_DEFAULT_TAB_LIST}"/>" onclick="fn_preMonthCon(this.href);return false;" onkeypress="this.onclick;"><img src="<c:out value="${contextPath}${imgPath}/common/btn_prev.gif"/>" alt="전달"/></a>&nbsp;
					<a href="<c:out value="${URL_DEFAULT_TAB_LIST}"/>&year=<c:out value="${nowYear}"/>&month=<c:out value="${nowMonth}"/>"><c:out value="${nowYM}"/></a>&nbsp;
					<a href="<c:out value="${URL_DEFAULT_TAB_LIST}"/>" onclick="fn_nextMonthCon(this.href);return false;" onkeypress="this.onclick;"><img src="<c:out value="${contextPath}${imgPath}/common/btn_next.gif"/>" alt="담달"/></a>
	</div>
