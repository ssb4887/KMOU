...
var gVarSPath = '<c:out value="${contextPath}/${param.sp}"/>';
var gVarCPath = '<c:out value="${contextPath}/include/js/editor/photo_uploader/popup"/>';
var gVarQuery = '?<c:out value="${queryString}"/>';
</script>
</head>
<body>
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="<c:out value="${contextPath}/${param.sp}"/>/editor/photoUploadProc.do?<c:out value="${queryString}"/>" method="post" enctype="multipart/form-data" onSubmit="return false;">
        <div id="pop_content2">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="<c:out value="${contextPath}/include/js/editor/img/photoQuickPopup/btn_confirm.png"/>" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="<c:out value="${contextPath}/include/js/editor/img/photoQuickPopup/btn_cancel.png"/>" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
<script type="text/javascript" src="<c:out value="${contextPath}/include/js/editor/photo_uploader/popup/jindo.min.js"/>" charset="utf-8"></script>
<script type="text/javascript" src="<c:out value="${contextPath}/include/js/editor/photo_uploader/popup/jindo.fileuploader.js"/>" charset="utf-8"></script>
<script type="text/javascript" src="<c:out value="${contextPath}/include/js/editor/photo_uploader/popup/attach_photo.js"/>" charset="utf-8"></script>
