...
public class KakaoErrorHandler extends DefaultResponseErrorHandler {

	private static final String FACEBOOK_PROVIDER_ID = "kakao";
	private static final Log logger = LogFactory.getLog(KakaoErrorHandler.class);
	...
	private String readResponseJson(ClientHttpResponse response)
		...
		if (logger.isDebugEnabled()) {
			logger.debug("Error from KAKAO: " + json);
		}
		return json;
	}
