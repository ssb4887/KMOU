...
public class LayoutTmpController extends LayoutTmpComController{
	...
	@RequestMapping("/layoutTmpList.do")
	 ...
	 */
	@ModuleAuth(name="MNG", accessModule={"menu", "website"})
	@RequestMapping(value = "/layoutTmpView.do")
	...
	public void fn_setCommonPath(ModuleAttrVO attrVO) {	
		...
		String listName = "layoutTmpList.do";
		String viewName = "layoutTmpView.do";
