...
import rbs.modules.sample.mapper.SampleFileMapper;
import rbs.modules.sample.mapper.SampleMapper;
import rbs.modules.sample.mapper.SampleMultiMapper;
...
public class SampleServiceImpl extends EgovAbstractServiceImpl implements SampleService {
	...
	@Resource(name="sampleFileMapper")
	private SampleFileMapper sampleFileDAO;
	
	@Resource(name="sampleMultiMapper")
	private SampleMultiMapper sampleMultiDAO;
	...
	public int insert(String uploadModulePath, int fnIdx, String regiIp, ParamForm parameterMap, JSONObject settingInfo, JSONObject items, JSONArray itemOrder) throws Exception  {
		...
		// 1. key 얻기
		param.put("fnIdx", fnIdx);
		int keyIdx = sampleDAO.getNextId(param);
	...
	public int update(String uploadModulePath, int fnIdx, int keyIdx, String regiIp, ParamForm parameterMap, JSONObject settingInfo, JSONObject items, JSONArray itemOrder) throws Exception {
		...
		if(result > 0){
			...
			if(fileDataList != null) {
				...
				int fleIdx = sampleFileDAO.getNextId(fileParam1);*/
