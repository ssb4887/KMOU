package rbs.modules.history.service;
...
public interface HistoryService {
	 ...
	 * @throws Exception
	 */
	public int update(String uploadModulePath, int fnIdx, int brdIdx, String regiIp, ParamForm parameterMap, JSONObject items, JSONArray itemOrder) throws Exception;
