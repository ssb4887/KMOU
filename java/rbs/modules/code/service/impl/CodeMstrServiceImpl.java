...
import rbs.modules.code.mapper.CodeMstrMapper;
 ...
 * @author user
 */
@Service("codeMstrService")
public class CodeMstrServiceImpl extends EgovAbstractServiceImpl implements CodeMstrService {

	@Value("${Globals.locale.lang.use}")
	protected int useLang;						// 언어사용여부
	
	@Resource(name="codeMstrMapper")
	private CodeMstrMapper codeMstrDAO;
	...
	public int getTotalCount(Map<String, Object> param) {
    	return codeMstrDAO.getTotalCount(param);
    }
	...
	public List<Object> getList(Map<String, Object> param) {
		return codeMstrDAO.getList(param);
	}
	...
	public DataMap getView(Map<String, Object> param) {
		DataMap viewDAO = codeMstrDAO.getView(param);
		return viewDAO;
	}
	...
	public DataMap getModify(Map<String, Object> param) {
		DataMap viewDAO = codeMstrDAO.getModify(param);
		return viewDAO;
	}
	...
	public int insert(String regiIp, ParamForm parameterMap, JSONObject items, JSONArray itemOrder) throws Exception  {
		...
		int duplicate = codeMstrDAO.getDuplicateCount(sparam1);
		if(duplicate > 0) {
			return -2;
		}
		...
		int ordIdx = codeMstrDAO.getMaxOrdIdx(null) + 1;
		...
		// 저장 항목
    	dataList.add(new DTForm("ISHIDDEN", parameterMap.get("isHidden")));
		...
		int result = codeMstrDAO.insert(param);
	...
	public int update(String mstCd, String regiIp, ParamForm parameterMap, JSONObject items, JSONArray itemOrder) throws Exception {
		...
		List<DTForm> dataList = new ArrayList<DTForm>();
		int hiddenFlag = StringUtil.getInt(parameterMap.get("hiddenFlag"));
		if(hiddenFlag > 0) searchList.add(new DTForm("ISHIDDEN", "0"));
	...
	public int getDeleteCount(Map<String, Object> param) {
    	return codeMstrDAO.getDeleteCount(param);
    }
	...
	public List<Object> getDeleteList(Map<String, Object> param) {
		return codeMstrDAO.getDeleteList(param);
	}
	...
	public int delete(int hiddenFlag, String[] deleteIdxs, String regiIp) throws Exception {
		...
		int result = codeMstrDAO.delete(param);
		return result;
	}
	...
	public int restore(int hiddenFlag, String[] restoreIdxs, String regiIp) throws Exception {
		...
		int result = codeMstrDAO.restore(param);
		return result;
	}
	...
	public int cdelete(int hiddenFlag, String[] deleteIdxs, JSONObject items, JSONArray itemOrder) throws Exception {
		...
		// 2. delete
		int result = codeMstrDAO.cdelete(param);		
		return result;
	}
