...
public interface ModuleService {
	 ...
	 * @return
	 */
	public int insert(String uploadModulePath, String regiIp, ParamForm parameterMap, JSONObject items, JSONArray itemOrder) throws Exception;
	 ...
	 * @return
	 */
	public int update(String uploadModulePath, int brdIdx, String regiIp, ParamForm parameterMap, JSONObject items, JSONArray itemOrder) throws Exception;
