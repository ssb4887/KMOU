 ...
 *
 */
public interface ModuleFnItemService {
	 ...
	 * @throws Exception
	 */
	public int insert(String uploadModulePath, String moduleId, int fnIdx, String regiIp, ParamForm parameterMap, JSONObject items, JSONArray itemOrder) throws Exception;
